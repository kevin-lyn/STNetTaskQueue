...
// STNetTaskQueue
#define COCOAPODS_POD_AVAILABLE_STNetTaskQueue
#define COCOAPODS_VERSION_MAJOR_STNetTaskQueue 0
#define COCOAPODS_VERSION_MINOR_STNetTaskQueue 0
#define COCOAPODS_VERSION_PATCH_STNetTaskQueue 7
